...
export default async function ParaVoce() {
        ...
        <div className="bg-[#e4e2e2] pt-10 pb-10 pl-4 pr-4">
          <div className="container mx-auto">            
            ...
            <div className="gap-6 sm:block md:block lg:flex xl:flex">
              ...
              <div className="grow-3 bg-white p-5 rounded-[12px] mb-7">
                ...
                <section aria-labelledby="extrato-financeiro">                  
                  ...
                  <div className="mb-10">                                    
                    <ul className="text-[16px] text-right">
                      {posts.map((post: any) => (        
                        <li key={post.id} className="mb-2.5 pb-2.5 border-b border-solid border-[#CCC]">
                          <p className="flex justify-between w-full">
                            {/* <span className="text-[#a7a7a7]">04/10/2025 - 15:30 hs</span> */}
                            <span className="text-[#666]">{post.title}</span>
                          </p>                        
                          <span className="flex justify-end items-center text-[#000] font-semibold">
                            {post.content} 
                            {/* <Image 
                              src={"/arrow-up.png"} 
                              alt="Arrow up" 
